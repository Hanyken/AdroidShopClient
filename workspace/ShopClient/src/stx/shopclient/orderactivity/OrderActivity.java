...
public class OrderActivity extends BaseActivity implements OnClickListener
{
	...
	protected View createMainView(ViewGroup parent)
	{
		...
		CatalogItem item = Repository.get(this).getItemsManager().getItem(ItemId);
		...
		imgIco.setImageBitmap(Repository.get(this).getImagesManager().getImage(item.getIco()));
	...
	public void onClick(View v)
	{
		...
		Repository.get(this).getOrderManager().addOrderItem(ItemId, items);
