...
public class ServiceResponseCode
{
	  ...
	  public static final int ITEM_NOT_FOUND = 6; //Элемент с таким идентификатором не найден
	  public static final int ORDER_CANT_DELETE = 7; //Для элемента сформирован счет, удаление невозможно
	  
	  public static final int SQL_SERVER_ERROR = 1000; //Внутрянняя ошибка SQL сервера
	  public static final int RETURN_EMPTY_STRING = 1001; //Возникает если процедура вернула пустую строку. По Вашему запросу ничего не найдено.
